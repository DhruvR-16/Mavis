...
### Roadmap (In Progress)
* **LSTM Action Recognition:** Automatically detects *which* exercise you are performing (Bicep Curl vs. Shoulder Press) without manual selection.
...
## 💪 How It Works 💪
To ensure accuracy, Mavis doesn't just check if an angle is < 90°. It tracks the Temporal State of the movement using a Finite State Machine (FSM).
